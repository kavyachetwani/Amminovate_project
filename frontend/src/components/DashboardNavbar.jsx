...
const DashboardNavbar = () => {
  ...
  return (
    <nav className="flex bg-[#cceede] justify-between h-[10%] ">
        ...
        <div onClick={handleToggleProfile} className=" relative">
          <AnimatePresence>
            ...
            >
              {toggleProfile && (
                <>
                  <motion.div className=" profileDivOpen rounded-[1rem] flex flex-col items-center justify-center shadow-custom bg-[#fae4b1] h-[50%] p-2">
          ...
          <img
            src={userpic}
            class=" p-[9px] h-[65px] rounded-[30px] text-[#5471F7] text-[27px] border border-[1px] border-[#5471F7] hover:cursor-pointer relative z-[120]"
          ></img>
          {/* </motion.div> */}
        </div>
      </div>
